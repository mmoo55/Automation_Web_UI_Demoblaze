Este archivo contiene los pasos para realizar la ejecución de la prueba. Se recomienda usar ItelliJ IDEA
Siga a detalle cada uno de los pasos siguientes:
	...
	Ejecución de la prueba:
	    ...
	    2. La ejecución de la prueba se puede realizar de diferentes maneras:
	        - Una vez dentro del proyecto presione las teclas Mayús+F10.
	        - Si esta usando IntelliJ IDEA, dentro del proyecto dirigirse al directorio /Automation_Web_UI/test_suite/test_purchase.py,
	          a continuación presione el ícono run (flecha verde)
	        - Abra una terminal en la ruta del proyecto o si esta en IntelliJ IDEA utilice la terminal que viene integrada, a continuación
	          utilice el siguiente comando: pytest .\test_suite\test_purchase.py --html=.\reports.\test_purchase.html
